...
class File(JsonDeserializable):
    """
    This object represents a file ready to be downloaded. The file can be downloaded via the link https://tapi.bale.ai/file/bot<token>/<file_path>. It is guaranteed that the link will be valid for at least 1 hour. When the link expires, a new one can be requested by calling getFile.
    ...
    :param file_path: Optional. File path. Use https://tapi.bale.ai/file/bot<token>/<file_path> to get the
        file.
